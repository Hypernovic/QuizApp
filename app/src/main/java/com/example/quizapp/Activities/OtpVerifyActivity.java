...
import com.example.quizapp.databinding.ActivityOtpVerifyBinding;
                        ...
                        FirebaseAuth
                            ...
                            public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    binding.progressBarVerify.setVisibility(View.VISIBLE);
                                    binding.btnVerify.setVisibility(View.INVISIBLE);
                                    Toast.makeText(OtpVerifyActivity.this, "Successfully Registered!", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(OtpVerifyActivity.this, RegistrationPage.class);
