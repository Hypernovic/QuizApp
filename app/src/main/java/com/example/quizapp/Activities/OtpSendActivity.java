...
import com.example.quizapp.databinding.ActivityOtpSendBinding;
    ...
    private void otpSend() {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                Toast.makeText(OtpSendActivity.this, "Verified Successfully without OTP", Toast.LENGTH_SHORT).show();

                mAuth.signInWithCredential(credential);
                Intent intent = new Intent(OtpSendActivity.this, RegistrationPage.class);
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                binding.progressBar.setVisibility(View.GONE);
                binding.btnSend.setVisibility(View.VISIBLE);
                Toast.makeText(OtpSendActivity.this, "OTP sent Successfully.", Toast.LENGTH_SHORT).show();
